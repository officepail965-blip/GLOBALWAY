      ...
      <div className="container-custom">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="section-title">
            Nos bureaux au{" "}
            <span className="text-brand-yellow-dark">Maroc, en France et en Tunisie</span>
          </h2>
        </div>
          ...
          {offices.map((o, idx) => (
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 rounded-xl bg-brand-blue text-brand-yellow flex items-center justify-center">
                  {o.icon}
                </div>
        ...
        <div className="bg-gradient-to-br from-brand-blue via-brand-blue-dark to-brand-blue rounded-3xl p-10 md:p-16 text-center relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 font-display">
              Pret a engager <span className="text-brand-yellow">votre transformation ?</span>
            </h2>
