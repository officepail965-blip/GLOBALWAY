const testimonials = [
  {
    quote:
      "GlobalWay nous a guidés vers ISO 9001 en moins de 9 mois. Méthode rigoureuse, équipe réactive — un accompagnement exemplaire.",
    role: "Directeur Général",
    sector: "Industrie — Maroc",
  },
  {
    quote:
      "Une approche digitale qui intègre le facteur humain. Nos équipes ont adhéré au changement dès le départ, ce qui est rare.",
    role: "DSI",
    sector: "Secteur ICT — France",
  },
  {
    quote:
      "Le coaching exécutif a profondément changé la dynamique de notre comité de direction. Des résultats mesurables en 3 mois.",
    role: "DRH Groupe",
    ...
    <section className="section-padding bg-brand-gray-50 relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="section-eyebrow">Témoignages clients</span>
